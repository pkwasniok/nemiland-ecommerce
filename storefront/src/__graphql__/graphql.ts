...
export type ProductPagePropsQuery = { __typename?: 'Query', product?: { __typename?: 'Product', id: string, slug: string, name: string, description: string, assets: Array<{ __typename?: 'Asset', source: string }>, facetValues: Array<{ __typename?: 'FacetValue', code: string, name: string, facet: { __typename?: 'Facet', code: string, name: string } }>, variants: Array<{ __typename?: 'ProductVariant', id: string, name: string }>, collections: Array<{ __typename?: 'Collection', name: string, slug: string }> } | null };
